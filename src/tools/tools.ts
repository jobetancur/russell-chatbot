...
export const saveClientDataTool = tool(
  async ({
    ...
    const saveCliente = await saveClientData(
      name,
      phone,
      email,
      city,
...
export const contactTool = tool(
  ...
  },
  {
    ...
    description:
      "Brinda el canal de contacto para otros servicios diferentes a los servicios contables y de revisoría fiscal ofrecidos por Russell Bedford Medellín. Esta tool se debe ejecutar cuando el cliente solicita información sobre otros servicios diferentes a los mencionados anteriormente.",
    schema: z.object({}),
  }
);
