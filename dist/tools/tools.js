...
export const saveClientDataTool = tool(async ({ name, phone, email, city, service, message, schedule, appointment_type }) => {
...
export const updateNotificationsTool = tool(async () => {
